(function (designer, $) {
    ...
    designer.saveData = function(status) {
        ...
        datas[0].content = "<div id='formWrapper' class='form-horizontal col-xs-12'>"+datas[0].content+"<div id='controlCount' data-control-count='"+count+"'></div></div><script>Hap.initForm('#formWrapper');</script>";
