...
<link href="${base.contextPath}/lib/kendoui/styles/kendo.hap.css?v=20170711" rel="stylesheet" type="text/css"/>
...
<script src="${base.contextPath}/lib/kendoui/js/kendo.hap.js?v=20170711"></script>
