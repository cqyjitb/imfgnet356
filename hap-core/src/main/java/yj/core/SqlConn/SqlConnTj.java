...
public class SqlConnTj {
    private static final String dbUrl="jdbc:sqlserver://192.168.60.2:1433;databasename=jb_data";
    private static final String dbUserName="UF_INTF"; // 用户名
    ...
    public static void main(String[] args) {
        ...
        SqlConnTj oracleConn = new SqlConnTj();
