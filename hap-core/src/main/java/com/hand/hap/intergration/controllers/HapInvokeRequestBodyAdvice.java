...
public class HapInvokeRequestBodyAdvice implements RequestBodyAdvice {
    ...
    private static String apiClazz = "com.hand.hap.api.gateway.controllers.ApiInvokeContoller";

//    private static String inboundClazz = "com.hand.hap.intergration.annotation.HapInbound";
