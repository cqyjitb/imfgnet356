...
//    private IHapInterfaceHeaderService headerService;
    ...
    public void contextInitialized(ApplicationContext applicationContext) {
        try{
            interfaceHeaderServiceClazz = Class.forName("com.hand.hap.intergration.service.IHapInterfaceHeaderService");
            if (interfaceHeaderServiceClazz != null){
                interfaceHeaderClazz = Class.forName("com.hand.hap.intergration.dto.HapInterfaceHeader");
    ...
    public Object inaroundMethod(ProceedingJoinPoint pjd, HapInbound bound) throws Throwable {
        ...
        try {
            ...
            if(interfaceHeaderServiceClazz != null && pjd.getTarget().getClass()
                    .getName().equalsIgnoreCase("com.hand.hap.intergration.controllers.HapApiController")) {
                result = new JSONObject();
                ((JSONObject) result).put("error", e.getMessage());
            }
        } finally {
