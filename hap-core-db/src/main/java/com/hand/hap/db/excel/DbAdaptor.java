package com.hand.hap.db.excel;

import static com.hand.hap.db.excel.TableData.TD;
import static com.hand.hap.db.excel.TableData.TR;
...
public class DbAdaptor {
    ...
    protected Long doInsert(TR tr) throws SQLException {
        ...
        Long genVal = null;
        TD genTd = null;
        try (PreparedStatement ps = ("hana".equalsIgnoreCase(dbType) || "postgresql".equalsIgnoreCase(dbType))
