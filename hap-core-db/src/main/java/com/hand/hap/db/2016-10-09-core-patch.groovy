...
//        dropIndex(tableName:"SYS_FUNCTION_B",  indexName:"SYS_RESOURCE_B_N2")
    ...
    if(mhi.isDbType('hana')) {
        changeSet(author: "qixiangyu", id: "20170731-patch-for-hana") {
            sqlFile(path: MigrationHelper.getInstance().dataPath("com/hand/hap/db/data/hana/patch/20170731-10990-1.sql"), encoding: "UTF-8")
        }
    }
    ...
    if(mhi.isDbType('hana')) {
        changeSet(author: "qixiangyu", id: "20170918-patch-for-hana") {
            sqlFile(path: MigrationHelper.getInstance().dataPath("com/hand/hap/db/data/hana/patch/20170918-10990-1.sql"), encoding: "UTF-8")
        }
    }
    ...
    if(mhi.isDbType('hana')) {
        changeSet(author: "niujiaqing", id: "20171012-category-type-length-hana") {
            sqlFile(path: MigrationHelper.getInstance().dataPath("com/hand/hap/db/data/hana/patch/20171012-1265.sql"), encoding: "UTF-8")
        }
    }
    ...
    if(mhi.isDbType('hana')) {
        changeSet(author: "qixiangyu", id: "201701113-qixiangyu-alter-sys_profile_value-hana") {
            sqlFile(path: MigrationHelper.getInstance().dataPath("com/hand/hap/db/data/hana/patch/20171113-10990.sql"), encoding: "UTF-8")
        }
    }
    ...
    changeSet(author: "jialongzuo", id: "201701113-jialongzuo-alter-data-permission") {
        ...
        sqlFile(path: MigrationHelper.getInstance().dataPath("com/hand/hap/db/data/hana/patch/20171030-10893.sql"), encoding: "UTF-8")
    ...
    if (!mhi.isDbType('hana') && !mhi.isDbType('postgresql')) {
